...
const FAQList: FAQProps[] = [
  {
    ...
    answer:
      "DMIF (Dr. Madhan Innovation of Future ) is an initiative to guide innovators, researchers, and entrepreneurs in transforming their ideas into patents, publications, and startups.",
    value: "item-1",
  },
  {
