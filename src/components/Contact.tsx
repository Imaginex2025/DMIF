...
export function ContactDark({
  ...
  const handleFocus = (fieldName:any) => setFocusedField(fieldName);
  ...
  return (
    <section id="Contact" className="min-h-screen  lg:h-[100vh] py-20 relative overflow-hidden ">
      ...
      <motion.h2
        ...
        viewport={{ once: true }}
      >
Contact        <span className="bg-gradient-to-b from-primary/60 to-primary text-transparent bg-clip-text">
          Us
        </span>
      </motion.h2>
          ...
          <div className="flex-1">
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 p-8 space-y-6 shadow-2xl relative">
