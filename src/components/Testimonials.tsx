...
const testimonials: TestimonialProps[] = [
  {
    ...
    logo: "/Companies/wells_fargo.png", // ✅ company logo
  },
  ...
  },
  {
    ...
    logo: "/Companies/californmia.png",
  },
];
...
return (
    <section id="testimonials" className="container py-6">
      ...
      <motion.p
        ...
        viewport={{ once: true }}
      >
        Experience what makes our program stand out. From unmatched value to
        proven results, hear from real people who have transformed their journey
        with us.
      </motion.p>

      {/* ✅ Fixed Grid Layout with Equal Height Cards */}
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {testimonials.map((t, index) => (
          ...
          >
            <Card
              className="flex flex-col justify-between h-full w-full cursor-pointer shadow-md hover:shadow-lg transition-all"
              onClick={() => openModal(t)}
            >
              <CardHeader className="flex flex-row items-center gap-4 pb-2 relative">
                <Avatar>
                  <AvatarImage alt="" src={t.image} />
      ...
      <AnimatePresence>
        {selectedTestimonial && (
          ...
          >
            <motion.div
              className="bg-white dark:bg-gray-800 rounded-lg max-w-2xl w-full max-h-[80vh] overflow-y-auto relative"
              ...
              <Card className="border-0 shadow-none">
                <CardHeader className="flex flex-row items-center gap-4 pb-4 relative">
                  ...
                  <img
                    ...
                    alt="Company Logo"
                    className="absolute top-2 right-20 h-16 w-16 object-contain"
                  />
                </CardHeader>
